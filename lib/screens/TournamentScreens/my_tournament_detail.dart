...
class MyDetailPage extends StatefulWidget {
  ...
  const MyDetailPage({Key? key, required this.tournament})
      : super(
          key: key,
        );

  @override
  State<MyDetailPage> createState() => MyDetailPageState();
}
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  trailing: ElevatedButton(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: Column(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  Provider.of<MatchProvider>(_scaffoldKey.currentContext!, listen: false).matchWin(
                                      homeTeam.id,
                                      match,
                    ...
                    child: match.winnerId == null
                        ? Text('Set Winner')
                        : Text(Provider.of<TeamProvider>(_scaffoldKey.currentContext!, listen: false)
                            .findTeam(match.winnerId)
                            .name),
                  ),
                );
              },
